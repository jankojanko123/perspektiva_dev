        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: 'create-account',
              asyncParams: {
                'perspektivaDocumentList':
                    getDoc(['perspektivas'], PerspektivasRecord.fromSnapshot),
              },
              builder: (context, params) => OnboardingCreateAccountWidget(
                perspektivaDocumentList: params.getParam(
                  'perspektivaDocumentList',
                  ParamType.Document,
                ),
              ),
            ...
            FFRoute(
              ...
              builder: (context, params) => DetailsWidget(
                perspektivaUUID: params.getParam(
                  'perspektivaUUID',
                  ParamType.String,
                ),
                perspektivaIsAlreadyGuessedByUser: params.getParam(
                  'perspektivaIsAlreadyGuessedByUser',
                  ParamType.bool,
                ),
                correctGuessOnBack: params.getParam(
                  'correctGuessOnBack',
                  ParamType.bool,
                ),
                postBack: params.getParam(
                  'postBack',
                  ParamType.bool,
                ),
                photoCompareResult: params.getParam(
                  'photoCompareResult',
                  ParamType.double,
                ),
              ),
            ...
            FFRoute(
              ...
              path: 'addPerspektiva',
              requireAuth: true,
              builder: (context, params) => const AddPerspektivaWidget(),
            ),
            FFRoute(
              name: 'TownList',
              path: 'townList',
              requireAuth: true,
              builder: (context, params) => const TownListWidget(),
            ),
            FFRoute(
              name: 'AdminDashboard',
              path: 'adminDashboard',
            ...
            FFRoute(
              ...
              requireAuth: true,
              builder: (context, params) => params.isEmpty
                  ? const NavBarPage(initialPage: 'TownList2')
                  : const TownList2Widget(),
            ),
            FFRoute(
              name: 'SubmitGuess_2',
              path: 'SubmitGuess_2',
              ...
              builder: (context, params) => SubmitGuess2Widget(
                perspektivaGuessURL: params.getParam(
                  'perspektivaGuessURL',
                  ParamType.String,
                ),
                perspektivaLocation: params.getParam(
                  'perspektivaLocation',
                  ParamType.LatLng,
                ),
                perspektivaID: params.getParam(
                  'perspektivaID',
                  ParamType.String,
                ),
                isCorrectGuess: params.getParam(
                  'isCorrectGuess',
                  ParamType.bool,
                ),
